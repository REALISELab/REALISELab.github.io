    ...
    return (
      ...
      <div className="bg-gray-900/5">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Diego Elias Damasceno Costa</h2>
            <p className="text-base leading-7 text-gray-600">Professor</p>
          ...
          <div className="ml-24">
            <img
              src="img/diego-elias-damasceno-costa.jpg"
