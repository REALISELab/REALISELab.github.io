...
- Beyond More Context: How Granularity and Order Drive Code Completion Quality, accepted at the Context Composition Workshop, colocated with the IEEE International Conference on Automated Software Engineering (ASE 2025) [Preprint](https://arxiv.org/abs/2510.06606).
- Reformulate, Retrieve, Localize: Agents for Repository-Level Bug Localization, accepted at the 7th International Workshop on Bots and Agents in Software Engineering, colocated with ICSE 2026 [Preprint](https://www.arxiv.org/abs/2512.07022).

### Professional Experience
- Laboratory Coordinator, Concordia University, SOEN 343 (Software Architecture and Design).
...
- Initiate and lead a reading group with students from Concordia University and industry professionals on the book “AI Engineering” by Chip Huyen. 
...
- Association for Computing Machinery and IEEE (member) (<em>2013 - Present</em>)

### Awards
- Concordia University Doctoral Graduate Fellowship (2025).
