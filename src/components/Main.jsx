  ...
  return (
    <Layout>
      ...
      <div className="lg:flex lg:justify-center lg:px-[200px] flex-wrap py-12">
          ...
          <div className="w-full flex flex-col md:flex-row md:justify-between md:mx-auto">
            <div className="md:w-[60%] md:px-12 px-5">
            ...
            <div className="md:w-[40%] md:px-12 px-7">
              <Tweet />
            </div>
          </div>
        ...
        <div className="flex justify-center my-4">
          ...
          <img 
            ...
            alt="Group Picture" 
            className="w-full max-w-[90%] md:max-w-[90%] lg:max-w-[90%] xl:max-w-[90%] rounded-lg shadow-lg"
