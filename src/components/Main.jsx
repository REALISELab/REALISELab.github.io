    ...
    <Layout>
      ...
      <div className="lg:flex lg:justify-center lg:px-[200px] flex-wrap py-12">
        ...
        <div className="w-full flex flex-col md:flex-row md:justify-between mx-auto px-8">
          <div className="w-full">
            <p className="relative mt-6 text-justify text-lg leading-8 text-gray-600">
              ...
              Concordia University is one of the top 100 universities under 50 years and has an exceptional Software Engineering program, currently ranked  <a href="https://csrankings.org/#/fromyear/2014/toyear/2025/index?soft&world" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">9th in the world</a>.
        ...
        <div className="flex justify-center my-4 px-8">
          <img
            src="img/group-pic-summer-2024.jpg"
            alt="Group Picture"
